// extract, removing the min. swap with the first number in array with the last and use pop.
// then swap the first with the smallest number.
 ...
 class MinHeap {
   ...
   insert(num) {
    ...
    while(this.heap[i] > this.heap[i*2] || this.heap[i] > this.heap[i*2+1]){
        if(this.heap[i*1] < this.heap[i*2] || this.heap[i*2 + 1] == null){
            let temp2 = this.heap[i*2]
            this.heap[i*2] = this.heap[i]
            this.heap[i] = temp2;
            i = i*2
        }else if(this.heap[i*2] > this.heap[i*2 + 1] || this.heap[i*2] == null){
            let temp3 = this.heap[i*2 + 1]
