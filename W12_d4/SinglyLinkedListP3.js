// for contains check if it has a number, if it fits move forward. // hint: look at print list
// 
// removeBack(), remove the last value, play with the pointer(next), (runner.next = another node, runner.next = null)

// average, need to calculate the average of the list. 1 + 2 + 3 / 3 , dont change the constructor();

// containsRecursive, make it recursive, inside the function do not use any whiles, use a if statment.
