// contains ; need to loop through index in a array
// in SLL we used the while loop through with .next

//  inorder, go to the left tree first then go to the right. (it is in order)
// preorder, go to the root, then call left then the right (copy the tree, is not in order)
// postorder, go to the left, then right, then go to the root

// toArrPreorder - make it into a array, vals need to change
// DFS means that (depth first search), go to the last node first.
/**
reference:
